  ...
  <div class="min-h-screen bg-zinc-950 text-white overflow-hidden">
    ...
    >
      ...
      <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <RouterLink
          to="/kanban"
          class="landing-cta group relative mx-auto inline-flex items-center justify-center gap-4 overflow-hidden rounded-3xl px-12 py-5 text-xl font-semibold text-white shadow-2xl shadow-violet-900/40 ring-2 ring-white/25 transition-all duration-300 hover:scale-[1.04] hover:shadow-violet-500/35 hover:ring-white/50 active:scale-[0.98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white/90"
        >
          <span
            class="absolute inset-0 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-cyan-400 opacity-95 transition-opacity duration-300 group-hover:opacity-100"
            aria-hidden="true"
          />
          <span
          ...
          <span class="relative z-10 flex items-center gap-3">
            <span class="text-2xl drop-shadow" aria-hidden="true">📋</span>
            <span>Открыть мою доску</span>
            <span
